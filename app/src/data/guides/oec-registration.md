...
- Exit Clearance
checklist:
- Register DMW E-Registration account
- Download DMW Mobile App
- Upload Passport and Visa
- Generate OFW Pass QR Code
---
...
*   **Active DMW E-Registration Account:** Must be registered on the [DMW Online Services Portal](https://onlineservices.dmw.gov.ph).
...
If you don't have one, create an account on the [DMW Online Services Portal](https://onlineservices.dmw.gov.ph). Ensure all profile details (Experience, Education, etc.) are complete.
...
- [DMW Mobile App](https://www.dmw.gov.ph)
