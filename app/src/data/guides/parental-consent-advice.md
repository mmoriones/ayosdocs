...
- Affidavit of Advice
checklist:
- Determine if you need Consent or Advice based on age
- Prepare the Affidavit (Consent or Advice)
- Have parents sign before a Notary Public or LCR
- Submit with Marriage License application
---

## 1. What are Parental Consent and Parental Advice?

Under the **Philippine Family Code**, individuals who wish to marry but have not yet reached the age of 25 are legally required to involve their parents or guardians in the process.

*   **Parental Consent:** Required for applicants aged **18 to 20**.
*   **Parental Advice:** Required for applicants aged **21 to 24**.

These documents are commonly used for:
*   Applying for a Marriage License at the Local Civil Registrar
*   Ensuring the legal validity of the marriage (for Consent)
*   Avoiding the mandatory 90-day waiting period (for Advice)
...
*   **Parents' Presence:** Ideally, parents should appear personally at the Local Civil Registrar (LCR).
*   **Valid IDs:** Of both the applicants and the parents/guardians.
*   **Affidavit Form:** A sworn statement of consent or advice.

### Additional Requirements (if applicable)
*   **Death Certificate:** If one parent is deceased.
*   **Notary Public:** If parents cannot appear personally at the LCR, the affidavit must be notarized.

💡 Tip: If your parents are abroad, they can have the affidavit "Apostilled" or authenticated at the nearest Philippine Consulate.
...
| LCR Filing Fee | Variable (usually included in license fee) |
| **Total** | **₱200 – ₱500** |
