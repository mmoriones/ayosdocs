...
- ADB Certificate
checklist:
- Identify the purpose (Visa, Loan, etc.)
- Visit your bank branch or use Online Banking
- Request the document with ADB (if needed)
...
*   **Valid ID:** At least one government-issued ID.
*   **Account Details:** Your account number or ATM card.
*   **Processing Fee:** Usually ₱100 to ₱200 per document.

### Additional Requirements (if applicable)
*   **Specific Purpose:** Some banks ask what the certificate is for (e.g., "For Korean Embassy") to use the correct format.

💡 Tip: If you need it for a visa, **always** request that the **Average Daily Balance (ADB)** for the last 6 months be included.
...
| Item | Estimated Cost |
|---|---|
| Bank Certificate | ₱100 – ₱200 |
| Bank Statement (per page/month) | ₱50 – ₱100 |
| **Total** | **₱100 – ₱300** |
