...
- QR Stamp Books
checklist:
- Choose your book format (Manual, Loose-leaf, or CAS)
- Buy or prepare your books
- Register via BIR ORUS portal
- Affix the QR Code Stamp
---
...
*   **BIR Certificate of Registration (Form 2303):** Photocopy of your COR.
*   **Valid ID:** Government-issued ID of the taxpayer.
*   **ORUS Account:** An active account on the [BIR Online Registration and Update System](https://orus.bir.gov.ph).
...
Log in to [orus.bir.gov.ph](https://orus.bir.gov.ph). Select **Secondary Registration** > **Register Books of Accounts**. Input the details of your books (type, volume number, and number of pages).
...
| BIR Registration Fee | Free (Abolished in 2024) |
| **Total** | **₱200 – ₱400** |
