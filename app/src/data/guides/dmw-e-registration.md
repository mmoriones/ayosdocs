...
- OFW Account
checklist:
- Create a DMW E-Registration Account
- Complete your profile (Experience, Education, etc.)
- Secure a Verified Contract from the MWO (POLO)
- Upload documents to the DMW portal (PopsDirect)
- Attend the DMW briefing/interview
---

## 1. What is DMW E-Registration?
...
### Online Portal
All registration and document uploads are done via the [DMW Online Services Portal](https://onlineservices.dmw.gov.ph).
...
Go to the [DMW Online Services Portal](https://onlineservices.dmw.gov.ph). Register using your active email address. **Important:** Your name must exactly match your passport.
...
- **DMW Central Office:** Ortigas, Mandaluyong (For final evaluation/interviews).
