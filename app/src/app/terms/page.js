        ...
        <section className="bg-ctp-mantle rounded-2xl p-8 md:p-14 shadow-sm border border-ctp-surface1 space-y-10">
          ...
          <div className="space-y-10 text-ctp-subtext1 leading-relaxed text-base font-medium">
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-ctp-text">1. Acceptance of Terms</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-ctp-text">2. Disclaimer of Liability</h2>
              <p>
              ...
              <div className="bg-ctp-sky-800/5 border-l-4 border-ctp-sky-800 p-4 rounded-r-xl italic font-semibold text-ctp-text">
                AyosDocs is not a government agency and does not represent any government entity.
              </div>
            </div>

            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-ctp-text">3. User Accounts</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-ctp-text">4. Intellectual Property</h2>
              <p>
            ...
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-ctp-text">5. Governing Law</h2>
              <p>
