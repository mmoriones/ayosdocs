            ...
            <div className="space-y-10">
              <div className="space-y-4">
                ...
                <div className="pl-1 space-y-1">
                  <p className="text-ctp-sky-800 font-bold text-lg">support@ayosdocs.com</p>
            ...
            <form className="space-y-6 bg-ctp-base p-8 rounded-2xl border border-ctp-surface1 shadow-lg" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <input
                  ...
                  minLength={2}
                  maxLength={100}
                  className="w-full px-5 py-3 bg-ctp-mantle border border-ctp-surface1 rounded-xl focus:ring-4 focus:ring-ctp-sky-800/10 focus:border-ctp-sky-800 outline-none transition-all text-ctp-text text-sm font-medium placeholder:text-ctp-subtext0 shadow-sm disabled:opacity-50"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  minLength={10}
                  maxLength={2000}
                  className="w-full px-5 py-3 bg-ctp-mantle border border-ctp-surface1 rounded-xl focus:ring-4 focus:ring-ctp-sky-800/10 focus:border-ctp-sky-800 outline-none transition-all text-ctp-text text-sm font-medium placeholder:text-ctp-subtext0 resize-none shadow-sm disabled:opacity-50"
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-ctp-sky-800 text-ctp-base py-4 px-6 rounded-xl font-bold text-sm hover:opacity-90 transition-all shadow-xl shadow-ctp-sky-800/20 active:scale-[0.98] flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
