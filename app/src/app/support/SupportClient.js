                ...
                <form className="grid grid-cols-1 md:grid-cols-2 gap-8" onSubmit={handleSubmit}>
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-ctp-base border border-ctp-surface1 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-ctp-sky-800 transition-all font-medium placeholder:text-ctp-subtext0 disabled:opacity-50"
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      disabled={isSubmitting}
                      className="w-full bg-ctp-base border border-ctp-surface1 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-ctp-sky-800 transition-all font-medium placeholder:text-ctp-subtext0 resize-none disabled:opacity-50 shadow-inner"
                    />
                  </div>
