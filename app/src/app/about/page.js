      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 mt-8 space-y-10">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <aside className="space-y-6">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={i} className="flex gap-4 group">
                    <div className="w-8 h-8 rounded-lg bg-ctp-base border border-ctp-surface1 flex items-center justify-center text-ctp-sky-800 shrink-0 group-hover:scale-105 transition-transform shadow-sm">
                      <item.icon size={16} />
                    </div>
            ...
            <div className="bg-ctp-sky-800 rounded-xl p-6 text-white relative overflow-hidden shadow-lg shadow-ctp-sky-800/20 group">
               ...
               <div className="relative z-10 space-y-4">
                  ...
                  <button className="w-full py-2 bg-white text-ctp-sky-800 rounded-lg font-bold text-[10px] uppercase tracking-widest hover:bg-opacity-90 transition-all shadow-sm">
                    Submit a Report
                  </button>
               </div>
            </div>
