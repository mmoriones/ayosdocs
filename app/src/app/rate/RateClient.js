        ...
        <div className="max-w-md w-full bg-ctp-mantle/50 rounded-xl border border-ctp-surface1 p-10 text-center space-y-8 shadow-sm">
          ...
          <div className="flex flex-col gap-3 pt-4">
            <button 
              ...
              className="w-full bg-ctp-sky-800 hover:bg-ctp-sky-800/90 text-white py-3 rounded-lg font-bold uppercase tracking-widest text-[10px] transition-all shadow-lg shadow-ctp-sky-800/10 active:scale-[0.98]"
            >
              Back to Offices
            </button>
            <button 
              ...
              className="w-full py-3 rounded-lg font-bold uppercase tracking-widest text-[10px] text-ctp-subtext1 bg-ctp-base/50 hover:bg-ctp-mantle transition-all border border-ctp-surface1"
            >
              Submit Another
            </button>
          </div>
          ...
          <div className="max-w-2xl mx-auto py-12 animate-in fade-in duration-500">
            <div className="bg-ctp-mantle/50 border border-ctp-surface1 rounded-xl p-12 text-center space-y-6 shadow-sm relative overflow-hidden group">
               ...
               <button 
                 ...
                 className="px-10 py-3 bg-ctp-sky-800 text-white rounded-lg font-bold text-[10px] uppercase tracking-widest shadow-lg shadow-ctp-sky-800/10 hover:bg-ctp-sky-800/90 active:scale-[0.98] transition-all relative z-10"
               >
                 Sign in to Unlock
               </button>
            </div>
            ...
            <aside className="w-full lg:w-80 shrink-0 space-y-6">
              <Card background="mantle" noPadding className="bg-ctp-mantle/50 border-ctp-surface1 shadow-sm overflow-hidden group">
                <div className="p-4 border-b border-ctp-surface1 flex items-center gap-2">
                  ...
                  <h3 className="text-[10px] font-bold text-ctp-subtext0 uppercase tracking-[0.15em]">Guidelines</h3>
                </div>
                  ...
                  <div className="space-y-2.5 pt-2">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-2.5">
                        ...
                        <span className="text-[10px] font-bold text-ctp-subtext1 uppercase tracking-tight">{text}</span>
                      </div>
                    ))}
                  </div>
                  <Button 
