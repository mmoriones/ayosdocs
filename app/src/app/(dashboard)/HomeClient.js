...
function GuestView({ trendingGuides, lastViewedSlug, allGuides }) {
  ...
  return (
    <div className="flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-[1600px] mx-auto">
      ...
      {/* Modern Search Bar */}
      <HomeSearchBar placeholder="What do you need to get done today?" className="max-w-2xl" allGuides={allGuides} />
...
function UserView({ firstName, userData, isLoading, allGuides, session, lastViewedSlug, trendingGuides }) {
  ...
  return (
    <div className="flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-700 max-w-md mx-auto">
      ...
      <HomeSearchBar placeholder="Search for a guide or agency..." allGuides={allGuides} />
...
function HomeSearchBar({ placeholder = "What do you need to get done today?", className = "", allGuides = [] }) {
