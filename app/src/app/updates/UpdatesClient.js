      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 mt-8 space-y-10">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          <aside className="w-full lg:w-64 shrink-0 space-y-8">
            ...
            <div className="bg-ctp-mantle rounded-xl p-5 border border-ctp-surface1 space-y-4 shadow-sm">
              ...
              <div className="space-y-4">
                {filteredUpdates.map((update, index) => (
                  <Link 
                    ...
                    className="group bg-ctp-base border border-ctp-surface1 rounded-xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:border-ctp-sky-800/30 hover:bg-ctp-mantle/50 transition-all shadow-sm"
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                           <span className="text-[9px] font-bold text-ctp-sky-800 bg-ctp-sky-800/5 px-1.5 py-0.5 rounded border border-ctp-sky-800/20 uppercase tracking-widest">Updated</span>
