          ...
          {user ? (
            <div className="flex items-center gap-4">
              {user.picture ? (
                ...
                <div className="w-10 h-10 bg-ctp-green text-ctp-base rounded-full flex items-center justify-center text-sm font-bold">
          ...
          <div className="pt-6 border-t border-ctp-surface0 pb-2">
            {user ? (
              ...
              <button
                ...
                className="w-full bg-ctp-green-600 text-ctp-base py-4 rounded-xl font-bold text-lg transition-all active:scale-[0.98] shadow-lg flex items-center justify-center gap-2"
              >
                <UserPlus size={20} />
                Login / Register
              </button>
