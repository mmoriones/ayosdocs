      ...
      <div className="flex items-center border-l border-ctp-surface0 pl-8 ml-2 gap-4">
        ...
        {!user ? (
          <button
            ...
            className="bg-ctp-sky-800 hover:opacity-90 text-ctp-base px-6 py-2.5 rounded-xl text-lg font-bold transition-all active:scale-95 shadow-lg"
          >
            Login
          </button>
        ) : (
          <div ref={dropdownRef} className="relative">
            ...
            >
              {user.picture ? (
                ...
                <div className="w-8 h-8 bg-ctp-sky-800 text-ctp-base rounded-full flex items-center justify-center text-xs font-bold">
                ...
                <div className="px-6 py-6 bg-ctp-mantle/30 border-b border-ctp-surface0">
                  <div className="flex items-center gap-4">
                    {user.picture ? (
                      ...
                      <div className="w-10 h-10 bg-ctp-sky-800 text-ctp-base rounded-full flex items-center justify-center text-lg font-bold shadow-sm">
                        {user.fullName.charAt(0)}
                      </div>
                    )}
