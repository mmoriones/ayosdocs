          ...
          <div className="flex-1 text-center lg:text-left space-y-10">
            ...
            {!isLoggedIn && (
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 pt-4">
                ...
                <Link to="/guides" className="text-ctp-sky-800/70 font-bold hover:text-ctp-sky-800 transition-colors text-[18px] border-b-2 border-transparent hover:border-ctp-sky-800/30 pb-1">
                  Browse all guides
                </Link>
              </div>
            )}
