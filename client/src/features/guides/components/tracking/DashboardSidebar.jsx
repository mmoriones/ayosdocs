  ...
  return (
    <aside className="w-full lg:w-[380px] shrink-0 space-y-8">
      ...
      <section className="bg-ctp-mantle rounded-[2rem] p-8 border border-ctp-surface0 shadow-sm">
        <div className="flex items-center justify-between mb-8">
          ...
          <button 
            ...
            className="text-[10px] font-black text-ctp-green hover:underline uppercase tracking-widest transition-all"
          >
            View all
          </button>
        </div>
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-5 group cursor-pointer">
            <div className="w-12 h-12 rounded-2xl bg-ctp-base border border-ctp-surface0 flex items-center justify-center text-ctp-subtext1 group-hover:bg-ctp-green/10 group-hover:text-ctp-green transition-all shadow-sm shrink-0">
              <Calendar size={20} />
            </div>
      ...
      <section className="bg-ctp-mantle rounded-[2rem] p-8 border border-ctp-surface0 shadow-sm">
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={i} className="flex items-center gap-4 p-4 rounded-2xl hover:bg-ctp-base border border-transparent hover:border-ctp-surface0 transition-all cursor-pointer group">
              <div className="w-10 h-10 rounded-xl bg-ctp-green/10 border border-ctp-green/20 flex items-center justify-center text-ctp-green shadow-sm shrink-0">
              ...
              <ChevronRight size={16} className="text-ctp-subtext1 group-hover:text-ctp-green transition-all group-hover:translate-x-1" />
            </div>
          ))}
        </div>
        ...
        <button 
          onClick={() => navigate('/coming-soon')}
          className="w-full mt-8 py-4 text-[11px] font-black text-ctp-green border border-ctp-green/20 rounded-2xl hover:bg-ctp-green/5 transition-all uppercase tracking-[0.2em] active:scale-[0.98] shadow-sm"
        >
      ...
      <section className="bg-ctp-mantle rounded-[2rem] p-8 border border-ctp-surface0 shadow-sm">
        <div className="flex items-center justify-between mb-8">
          ...
          <select className="text-[10px] font-black text-ctp-green bg-ctp-base border border-ctp-surface0 rounded-lg px-3 py-1.5 focus:ring-2 focus:ring-ctp-green/20 transition-all cursor-pointer uppercase tracking-widest shadow-sm">
      ...
      {/* Motivation Widget */}
      <section className="bg-ctp-green rounded-[2rem] p-8 text-ctp-base relative overflow-hidden group border border-ctp-green/20 shadow-xl shadow-ctp-green/10">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <button className="w-full py-4 bg-ctp-base text-ctp-green rounded-2xl font-black text-[11px] shadow-2xl hover:opacity-95 transition-all uppercase tracking-[0.2em] active:scale-95">
            Explore guides
          </button>
        </div>
      </section>
