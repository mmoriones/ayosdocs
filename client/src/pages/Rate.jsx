  ...
  const StarRating = ({ category, label, icon: Icon }) => {
    return (
      <div className="bg-ctp-mantle border border-ctp-surface0 rounded-3xl p-6 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
        <div className="w-12 h-12 rounded-2xl bg-ctp-green/10 flex items-center justify-center text-ctp-green mb-4">
          <Icon size={24} />
        </div>
          ...
          <label key={option.value} className="flex items-center gap-2.5 cursor-pointer group">
            <div className="relative flex items-center justify-center">
              <input
                ...
                className="peer appearance-none w-5 h-5 rounded-full border-2 border-ctp-surface0 checked:border-ctp-green transition-all cursor-pointer bg-ctp-base"
              />
  ...
  return (
    <div className="min-h-screen bg-ctp-base font-sans pb-20">
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 py-10">
        ...
        <Link 
          to="/guides" 
          className="inline-flex items-center gap-2 text-ctp-green font-bold text-xs hover:gap-3 transition-all mb-6"
        >
          <ArrowLeft size={14} />
          Back to All Guides
        </Link>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-1 space-y-12">
            ...
            {/* Info Banner */}
            <div className="bg-ctp-green/5 border border-ctp-green/10 rounded-2xl p-5 flex items-start gap-4">
              <div className="w-9 h-9 rounded-xl bg-ctp-mantle border border-ctp-green/20 flex items-center justify-center text-ctp-green shrink-0">
                <ShieldCheck size={18} />
              </div>
              <div>
            ...
            <section className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ctp-green text-ctp-base flex items-center justify-center text-xs font-black">1</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5 pl-10">
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <select className="w-full appearance-none bg-ctp-base border border-ctp-surface0 rounded-xl px-3.5 py-2.5 pr-10 text-ctp-subtext1 focus:outline-none focus:ring-2 focus:ring-ctp-green/10 focus:border-ctp-green transition-all text-xs font-medium cursor-pointer">
            ...
            <section className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ctp-green text-ctp-base flex items-center justify-center text-xs font-black">2</div>
            ...
            <section className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ctp-green text-ctp-base flex items-center justify-center text-xs font-black">3</div>
            ...
            <section className="space-y-5">
              <div className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-ctp-green text-ctp-base flex items-center justify-center text-xs font-black">4</div>
              ...
              <div className="pl-10 space-y-4">
                <div className="relative">
                  <textarea 
                    ...
                    maxLength={500}
                    className="w-full min-h-[140px] bg-ctp-base border border-ctp-surface0 rounded-2xl p-5 text-xs text-ctp-text placeholder:text-ctp-subtext0 focus:outline-none focus:ring-2 focus:ring-ctp-green/10 focus:border-ctp-green transition-all resize-none shadow-sm"
                  />
            ...
            <div className="pl-10 pt-4">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-ctp-mantle rounded-xl border border-ctp-surface0">
                ...
                {user ? (
                  <button className="w-full sm:w-auto px-8 py-2.5 bg-ctp-green text-ctp-base rounded-full font-bold text-xs hover:bg-ctp-green/90 transition-all shadow-md shadow-ctp-green/20 active:scale-95">
                    Submit Experience
                  </button>
                ) : (
                  <button 
                    onClick={openAuthModal}
                    className="w-full sm:w-auto px-8 py-2.5 bg-ctp-green text-ctp-base rounded-full font-bold text-xs hover:bg-ctp-green/90 transition-all shadow-md shadow-ctp-green/20 active:scale-95"
                  >
                    Log in to submit
                  </button>
                )}
          ...
          <aside className="w-full lg:w-[380px] shrink-0 space-y-8">
            ...
            <section className="bg-ctp-mantle rounded-3xl p-6 border border-ctp-surface0 shadow-sm relative overflow-hidden group">
              ...
              <div className="relative mb-6 flex justify-center">
                <div className="absolute inset-0 bg-ctp-green/5 rounded-full scale-150 blur-3xl opacity-50" />
              ...
              <div className="space-y-5 relative z-10">
                {[
                  ...
                  <div key={i} className="flex items-start gap-3">
                    <div className="w-4 h-4 rounded-full bg-ctp-green/10 flex items-center justify-center shrink-0 mt-0.5">
                      <CheckCircle2 size={12} className="text-ctp-green" />
                    </div>
            ...
            {/* What happens next? */}
            <section className="bg-ctp-mantle rounded-3xl p-6 border border-ctp-surface0 shadow-sm">
              <h3 className="text-base font-bold text-ctp-green mb-6">What happens next?</h3>
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    <div className="w-6 h-6 rounded-full bg-ctp-green text-ctp-base flex items-center justify-center text-[10px] font-black shrink-0">
                      {step.step}
                    </div>
                    <div>
                ...
                <div className="pt-2 flex items-start gap-3">
                  <div className="text-ctp-green shrink-0">
                    <ShieldCheck size={18} />
                  </div>
