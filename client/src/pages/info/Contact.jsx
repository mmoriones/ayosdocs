          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-ctp-sky-800 font-medium">contact@ayosdocs.com</p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  <span className="text-ctp-sky-800 cursor-pointer hover:underline">Facebook</span>
                  <span className="text-ctp-sky-800 cursor-pointer hover:underline">Twitter</span>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  required
                  type="text"
                  className="w-full px-4 py-2 bg-ctp-base border border-ctp-surface0 rounded-lg focus:ring-2 focus:ring-ctp-sky-800 focus:border-transparent outline-none transition-all text-ctp-text"
              ...
              <button
                type="submit"
                className="w-full bg-ctp-sky-800 text-ctp-base py-2 px-4 rounded-lg font-semibold hover:bg-ctp-sky-800/90 transition-colors shadow-sm"
              >
                Send Message
              </button>
            </form>
