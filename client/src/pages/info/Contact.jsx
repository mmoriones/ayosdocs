      ...
      <div className="max-w-4xl mx-auto space-y-8">
        <section className="bg-ctp-mantle rounded-2xl p-8 md:p-12 shadow-sm border border-ctp-surface0 space-y-6">
          <h1 className="text-3xl md:text-4xl font-bold text-ctp-text">
            Contact <span className="text-ctp-green">Us</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-ctp-green font-medium">contact@ayosdocs.com</p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-4">
                  <span className="text-ctp-green cursor-pointer hover:underline">Facebook</span>
                  <span className="text-ctp-green cursor-pointer hover:underline">Twitter</span>
                </div>
              </div>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                ...
                <input
                  required
                  type="text"
                  className="w-full px-4 py-2 bg-ctp-base border border-ctp-surface0 rounded-lg focus:ring-2 focus:ring-ctp-green focus:border-transparent outline-none transition-all text-ctp-text"
              ...
              <button
                type="submit"
                className="w-full bg-ctp-green text-ctp-base py-2 px-4 rounded-lg font-semibold hover:bg-ctp-green/90 transition-colors shadow-sm"
              >
                Send Message
              </button>
            </form>
