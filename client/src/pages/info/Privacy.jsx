        ...
        <section className="bg-white rounded-2xl p-8 md:p-12 shadow-sm border border-gray-100 space-y-6">
          ...
          <div className="space-y-6 text-gray-600 leading-relaxed text-sm md:text-base">
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-800">1. Log Files</h2>
              <p>
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-800">2. Cookies and Web Beacons</h2>
              <p>
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-800">3. Google DoubleClick DART Cookie</h2>
              <p>
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-800">4. Information We Collect</h2>
              <p>
            ...
            <div className="space-y-3">
              <h2 className="text-xl font-bold text-gray-800">5. Consent</h2>
              <p>
