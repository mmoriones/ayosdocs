    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-ctp-base">
        <div className="flex flex-col items-center gap-4">
          <Loader2 className="animate-spin text-ctp-green" size={40} />
    ...
    <div className="min-h-screen bg-ctp-base font-sans pb-20">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-10 py-10">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
          ...
          <button className="flex items-center gap-3 px-8 py-4 bg-ctp-mantle border border-ctp-green/30 text-ctp-green rounded-2xl font-black text-[13px] uppercase tracking-widest shadow-lg hover:shadow-xl hover:border-ctp-green transition-all active:scale-95">
          ...
          <div className="flex-1 space-y-16">
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <select 
                      ...
                      className="appearance-none bg-ctp-mantle border border-ctp-surface0 rounded-2xl px-6 py-3.5 pr-12 text-[11px] font-black uppercase tracking-widest text-ctp-subtext1 focus:ring-4 focus:ring-ctp-green/10 transition-all cursor-pointer shadow-sm"
                    >
              ...
              <div className="relative group">
                <Search size={20} className="absolute left-5 top-1/2 -translate-y-1/2 text-ctp-subtext1 transition-colors group-focus-within:text-ctp-green" />
                <input 
                  type="text"
                  placeholder="Search your tracked guides and goals..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-14 pr-6 py-5 bg-ctp-mantle border border-ctp-surface0 rounded-[2rem] text-[18px] shadow-sm focus:ring-4 focus:ring-ctp-green/10 focus:border-ctp-green transition-all text-ctp-text placeholder:text-ctp-subtext0 font-medium"
                />
              </div>
            </div>
            ...
            <section className="space-y-10">
              <div className="flex items-end justify-between border-b border-ctp-surface0 pb-6">
                ...
                <button 
                  ...
                  className="group flex items-center gap-2 text-ctp-green font-black text-[11px] uppercase tracking-widest hover:text-ctp-green-500 transition-colors mb-1"
                >
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <button 
                  onClick={() => navigate('/coming-soon')}
                  className="w-full py-10 bg-ctp-mantle border-2 border-dashed border-ctp-surface0 rounded-[2.5rem] text-ctp-subtext0 hover:text-ctp-green hover:border-ctp-green/30 hover:bg-ctp-green/5 transition-all flex flex-col items-center justify-center gap-4 group"
                >
                  <div className="w-14 h-14 rounded-2xl bg-ctp-base border border-ctp-surface0 flex items-center justify-center group-hover:scale-110 transition-transform shadow-sm">
                    <Plus size={28} className="text-ctp-subtext0 group-hover:text-ctp-green" strokeWidth={3} />
                  </div>
            ...
            <section className="space-y-10">
              <div className="flex items-end justify-between border-b border-ctp-surface0 pb-6">
                ...
                <Link to="/guides" className="group flex items-center gap-2 text-ctp-green font-black text-[11px] uppercase tracking-widest hover:text-ctp-green-500 transition-colors mb-1">
              ...
              <div className="grid grid-cols-1 gap-6">
                {filteredGuides.length > 0 ? (
                  ...
                  <div className="text-center py-24 bg-ctp-mantle rounded-[3rem] border-2 border-dashed border-ctp-surface0">
                    ...
                    <Link to="/guides" className="mt-8 inline-block px-8 py-4 bg-ctp-green text-ctp-base rounded-xl font-black uppercase tracking-widest shadow-lg active:scale-95 transition-all">Explore all guides</Link>
                  </div>
                )}
