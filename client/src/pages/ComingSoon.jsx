    ...
    <div className="min-h-screen bg-ctp-base flex items-center justify-center px-6 py-20 font-sans">
      <div className="max-w-2xl w-full text-center space-y-12">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-ctp-green/20 blur-3xl rounded-full scale-150 animate-pulse" />
          <div className="relative flex justify-center">
            <div className="w-24 h-24 bg-ctp-mantle rounded-3xl shadow-xl shadow-ctp-green/10 flex items-center justify-center text-ctp-green border border-ctp-surface0 relative overflow-hidden group">
              <div className="absolute inset-0 bg-ctp-green/5 scale-0 group-hover:scale-100 transition-transform duration-500 rounded-full" />
        ...
        <div className="space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-ctp-green/10 border border-ctp-green/20 rounded-full text-ctp-green text-xs font-bold uppercase tracking-widest mb-4">
            <Construction size={14} />
            Feature in Development
          </div>
          <h1 className="text-4xl md:text-5xl font-black text-ctp-text tracking-tight leading-tight">
            We're building something <span className="text-ctp-green">amazing.</span>
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto text-left">
          <div className="bg-ctp-mantle p-5 rounded-3xl border border-ctp-surface0 shadow-sm flex items-start gap-4">
            <div className="w-10 h-10 rounded-2xl bg-ctp-green/10 flex items-center justify-center text-ctp-green shrink-0">
               <ShieldCheck size={20} />
            </div>
            <div>
